...
char data1[] = "hello world pankaj DS GROUP";
...
//  MY_FLASH_WriteN(0x00000000,(uint32_t *)data2,9,2);
//  MY_FLASH_ReadN(0x00000000,Rx_Data,9,2);
//
//   MY_FLASH_SetSectorAddrs(11, 0x080E0000);
//   int numofwords1 = (strlen(data1)/4)+((strlen(data1)%4)!=0);
